                        ...
                        <div class="panel-body">
                            <div class="col-md-8">
                                ...
                                <form role="form" action="./user/add" method="post">
                                    ...
                                    if(isset($data['mess'])){
                                    ?>
                                    <div class="alert alert-danger">Email hoặc password sai! Mời bạn nhập lại</div>
                                    <?php
                                    }
                                    ?>
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input name="user_mail" required id="user_mail"  type="text" class="form-control">
                                </div>
                                <div style="color: red;" id="message_user"></div>                      
                                <div class="form-group">
